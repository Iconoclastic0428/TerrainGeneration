...
void Object::LoadTexture(std::string fileName, int val){
        // Load our actual textures
        m_textureDiffuse.LoadTexture(fileName, val);
}
...
void Object::MakeTexturedQuad(std::string fileName, int val){
        ...
        m_textureDiffuse.LoadTexture(fileName.c_str(), val);
}
